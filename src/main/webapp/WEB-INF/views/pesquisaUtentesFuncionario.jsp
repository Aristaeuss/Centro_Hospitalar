...
<html lang='en'>
  ...
  <body>
    <div class="main">
      ...
      <div  class="pageIdentifier">PESQUISA DE UTENTES</div>
      <div class="transparentCardBar">
      </div>
      <div class="scheduledAppointmentsDiv">

      <c:if test="${utentes==null}">
        <table>
          <thead>
              <tr>
                  <td>Nome</td>
          ...
          <tr>
              ...
              <td>${utente.getNif()}</td>
              <td>${utente.getAge()}</td>
              <td>${utente.getTelephone()}</td>
              <td>${utente.getEmail()}</td>
              <td><a href="verConsultasFuncionario/${utente.getNif()}">Ver consultas</a></td>
              <td><a href="perfilUtenteStatic/${utente.getNif()}">Ver perfil</a></td>
          </tr>
          </tbody>
        </c:if>
      ...
      <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>${utente.getEmail()}</td>
                <td><a href="verConsultasFuncionario/${utente.getNif()}">Ver consultas</a></td>
                <td><a href="perfilUtenteStatic/${utente.getNif()}">Ver Utente</a></td>
            </tr>
            </c:forEach>
        </tbody>
      </table>
