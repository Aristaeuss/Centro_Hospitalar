...
<body>
    ...
    <div class="main" >
        ...
        <div  class="pageIdentifier">
            <p class="pageIdentifier">REGISTOS <c:if test="${success!=null}">${success}</c:if></p>
        </div>
        ...
        <div class="transparentCardBar">
            ...
            <div class="card" id="card1"  >
                ...
                <div class="buttonCard">
                    <a href="/RegistosA/Utente">REGISTAR</a>
                </div>
            </div>


            <div class="card" id="card2"  >
                <img class="cardImages" id="cardImage2" src="../Images/iconSchedule.png">
                <div class="updatedInfo">
                    <p>Registo de Médicos</h3>
                </div>
                <div class="buttonCard">
                    <a href="/Registos/Medico">REGISTAR</a>
                </div>
            </div>

            <div class="card" id="card3"  >
                <img class="cardImages" id="cardImage3" src="../Images/iconSchedule.png">
                <div class="updatedInfo">
                    <p>Registo de Funcionários</h3>
                </div>
                <div class="buttonCard">
                    <a href="/Registos/Funcionario">REGISTAR</a>
                </div>
            </div>

            <div class="card" id="card4"  >
                <div class="updatedInfo">
                    <p>Links para self-register</p>
                    </div>
                    <div><a href="/registo">Utente</a></div>
                    <div><a href="/registoF">Funcionário</a></div>
                    <div><a href="/registoM">Médico</a></div>
            </div>
