  ...
  <body>
    ...
    <div class="main">
                    ...
                    <div class="day-schedule">
                      ...
                      <div class="hours">
                         <c:forEach var="slot" items="${slotsForDoctor}">
                            <a class="hourButton" href="/consultaMarcada/${slot.getId()}">${slot.getDateTime().toLocalTime()}</a>
                         </c:forEach>
                      </div>
                    </div>
                  </div>
      ...
      <div class="popup filter">
        ...
        <form class="specialityForm" name="scheduleForm" id="scheduleForm" method="post" action="/calendarioUtenteE" modelAttribute="User">
        ...
        <form class="doctorForm" name="doctorForm" id="doctorForm" method="post" action="/calendarioUtenteM" modelAttribute="User">
