...
<html lang='en'>
  ...
  <body>
    <div class="main">
      ...
      <div  class="pageIdentifier">PÁGINA DE CONFIRMAÇÃO DE CONSULTA</div>
      ...
      <c:if test="${errorMessage==null}">
        <h3>Ficou marcada a consulta para o utente: ${scheduledAppointment.getPatient().getPreferredName()}</h3>
        <h4><b>Detalhes da consulta:</b></h4>
        ...
        <p>Data: ${scheduledAppointment.getSlot().getDateTime().toLocalDate()}</p>
