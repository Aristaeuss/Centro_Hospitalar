        ...
        <div class="transparentCardBar">
            ...
            <div class="card" id="card1"  >
                ...
                <div class="updatedInfo">
                    <h2><b>${doctorsToday.size()}</b> MÉDICOS</h2>
                    <p>presentes</p>
                </div>
                <div class="buttonCard">
                    <a href="listaMedicosPresentesFuncionario">VER MÉDICOS</a>
                </div>
            </div>
            ...
            <div class="card" id="card2">
                ...
                <div class="updatedInfo">
                    <h2><b>${doctors.size()}</b> MÉDICOS</h2>
                    <p>trabalham no Centro Hospitalar</h3>
                        <div class="cardSubText">
                            <p></p>
                        </div>
                </div>
                <div class="buttonCard">
                    <a href="listaMedicosFuncionario">VER LISTA</a>
                </div>
            </div>
