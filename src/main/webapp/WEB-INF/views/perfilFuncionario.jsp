...
<div class="main">
    ...
    <div  class="pageIdentifier">PERFIL DE FUNCIONÁRIO</div>
    ...
    <div class="content-profile">
        ...
        <div class="category">Funcionário</div>
    ...
    <div class="perfilInfo">
        ...
        <div class="column1 raw7">IBAN:</div>
        <div class="column2">${loggedInUser.getIban()}</div>
    </div>
    </div>

    <div class="popup hidden">
        <div class="title">Altere os dados da sua morada:</div>
        <form id="addressUpdate-form" method="post" action="/alterarMoradaF" >
        <input class="field-input-address" type="text" id="adress" name="address" placeholder="Morada" required>
    ...
    <div class="popup1 hidden">
        <div class="title">Altere o seu número de telefone: ${loggedInUser.getTelephone()}</div>
        <form id="telephoneUpdate-form" method="post" action="/alterarTelefoneF" >
    ...
    <div class="popup2 hidden">
        ...
        <div class="profile-image-wrapper">
            <form id="upload-form" method="post" action="/alterarImagemF" enctype="multipart/form-data">
        ...
        <button type="submit" class="image-submit-button">Enviar</button>
         ...
         <form id="upload-form" method="post" action="/alterarNomeF">
