    ...
    <div class="register-grid">
        <div class="register-flex">
            ...
            <div class="instructions">
                <p>Doutor(a), faça aqui o registo na nossa plataforma</p>
            </div>
            <div class="registerForm">
                <form class="registerForm" id="register-form" method="post" action="/registoM" modelAttribute="User">
                    ...
                    <span class="errorMessage" style="color: red">${errorMessageOrderNumber}</span>
                    ...
                    <input class="field-input" type="text" id="address" name="address" placeholder="Morada"required>
                    <input class="field-input" type="text" id="doorNumber" name="doorNumber" placeholder="Nº porta"required>
                    <input class="field-input" type="text" id="floor" name="floor" placeholder="Andar">
                    <input class="field-input" type="text" id="postalCode" name="postalCode" placeholder="Código Postal"required>
                    <input class="field-input" type="text" id="city" name="city" placeholder="Concelho"required>
                    ...
                    <textarea class="field-input" id="about-me" name="aboutMe" maxlength="500" placeholder="Texto sobre o médico... (MAX 500)"></textarea>
                    <div class="separator">
                        - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
                    </div>
