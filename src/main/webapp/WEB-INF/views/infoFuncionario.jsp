...
<div class="main">
    ...
    <div  class="pageIdentifier">INFORMAÇÃO GERAL</div>
    <div class="full-info-wrapper">
         <article class="about"><h5>Conheça o Centro Hospitalar UpSkill</h5>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Odit dolor esse omnis dicta.
         ...
         <article class="partners"><h5>Parceiros:</h5>
