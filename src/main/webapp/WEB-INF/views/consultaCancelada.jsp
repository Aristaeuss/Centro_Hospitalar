...
<html lang='en'>
  ...
  <body>
    <div class="main">
      ...
      <h3>
      <c:if test="${canceledByEmployee}">
        A consulta do utente ${scheduledAppointment.getPatient().getPreferredName()} foi cancelada.
      </c:if>
      <c:if test="${!canceledByEmployee}">
        ${loggedInUser.getName()}, a sua consulta foi cancelada.
      </c:if>
      </h3>
