...
<body>
    ...
    <div class="main">
        ...
        <div id="headerText" class="fixedText">
            ...
            <p id="headerSubText">O Centro Hospitalar UPskill inspira-se nos seus clientes para estar na vanguarda na
                proteção das famílias. Estamos mais inovadores na prestação de cuidados de saúde, mais próximos e mais
                ágeis.</p>
        </div>

        <div class="pageIdentifier">
            <p class="pageIdentifier">REGISTO DE UTENTE</p>
        </div>
        ...
        <form class="register-flex" id="register-form" method="post" action="/registoFuncionarioU" modelAttribute="User">
            <input class="field-input" type="text" id="name" name="name" placeholder="Nome completo" required>
            <input class="field-input" type="text" id="preferredName" name="preferredName"
                placeholder="Indique os 2 nomes por que deseja ser tratado" required>
            ...
            <input class="field-input" type="number" id="socialSecurity" name="socialSecurity"
                placeholder="Segurança Social" required>
            <input class="field-input" type="number" id="patientNumber" name="patientNumber"
